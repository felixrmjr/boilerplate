...
namespace Business.Domain.Extensions
{
    ...
    {
        static IRedisRepository redis = ServiceLocator.Resolve<IRedisRepository>();

        public static async Task<string> EncryptPlainTextToCipherText(string PlainText)
        {
        ...
        public static async Task<string> DecryptCipherTextToPlainText(string CipherText)
        {
